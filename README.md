...
- 🔭 Currently building **go_fast** — a GPS navigation app with offline maps & real-time tracking
- 📱 Specialized in **Flutter** for mobile, desktop and Android Auto
- 🧩 I design with **Clean Architecture** — data, domain, and presentation layers
- 🌐 Full-stack experience: **Node.js** backends, **React** frontends, **PostgreSQL** databases
- ⚡ Passionate about offline-first apps, geolocation systems, and AI-driven UX
...
<p align="left">
  <img src="https://skillicons.dev/icons?i=js,ts,react" alt="JavaScript, TypeScript, React" />
</p>

**Backend & Database**

<p align="left">
  <img src="https://skillicons.dev/icons?i=nodejs,postgres,sqlite" alt="Node.js, PostgreSQL, SQLite" />
</p>
...
|---------|-------------|-------|
| [**go_fast**](https://github.com/Qsuma/go_fast) | GPS navigation app with offline maps, real-time tracking | Flutter · Mapbox · SQLite |
| [**EV-Map**](https://github.com/Qsuma/EV-Map) | Electric vehicle charging station map | Flutter · Dart |
| [**happyMotherDay**](https://github.com/Qsuma/happyMotherDay) | Interactive TypeScript web experience | TypeScript |
| [**node_consola_interactiva**](https://github.com/Qsuma/node_consola_interactiva) | Interactive CLI console | Node.js |
